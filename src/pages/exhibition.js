...
import ExhibitionStyles from '../styles/exhibition.module.scss';

const Exhibition = () => {

    return(
        <Layout>
            <Head title='Exhibition' />
            <div className={ExhibitionStyles.exhibitionContainerMobile}> 
                <div className={ExhibitionStyles.exhibitionContainer}>
                    <div className={ExhibitionStyles.awardsContainerMobile}>
                    ...
                    <div className={ExhibitionStyles.exhibitionHistoryMobile}>
